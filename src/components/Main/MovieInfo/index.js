...
const MovieInfo = ({title, rating, rated, runTime, year, genre, cast, plot}) => {
  ...
  return (
    <Flex grow={1} h={{base: window.innerHeight/2, sm: "86vh", lg: "auto"}} borderTopRadius={"16px"} bg={{base: "#161A1D"}} position={{base: "relative", md: "static"}} bottom={{base: newBottom, sm: 0}} transition={"bottom 1s"} overflowY={{base: "scroll", lg: "auto"}} direction={"column"} rowGap={{base: "8px", md: "16px"}} p={{base: "4px 8px", lg: "0"}}>
