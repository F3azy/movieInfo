...
const MovieInfo = ({title, rating, rated, runTime, year, genre, cast, plot}) => {
  ...
  return (
    <Flex grow={1} h={{base: window.innerHeight/1.1, sm: "86vh", lg: "auto"}} borderTopRadius={"16px"} bg={{base: "#161A1D"}} position={{base: "relative", md: "static"}} bottom={{base: newBottom, sm: 0}} transition={"bottom 1s"} overflowY={{base: "scroll", lg: "auto"}} direction={"column"} rowGap={"16px"} p={{base: "0 8px", lg: "0"}}>
